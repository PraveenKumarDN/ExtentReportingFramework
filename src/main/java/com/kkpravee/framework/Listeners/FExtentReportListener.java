...
public class FExtentReportListener extends TestListenerAdapter {
    ...
    public void onStart(ITestContext iTestContext) {
        System.out.println("onStart, test suite executed is: " + iTestContext.getName());
    ...
    public void onTestStart(ITestResult iTestResult) {
        ...
        test = startTest(iTestResult.getMethod().getMethodName(),iTestResult.getMethod().getDescription());
    }
   ...
   public void onFinish(ITestContext iTestContext) {
       System.out.println("onFinish, test suite executed is: " + iTestContext.getName());
